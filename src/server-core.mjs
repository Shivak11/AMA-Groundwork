...
export async function createWorkshopServer(options={}) {
  ...
  const server = new McpServer({name:'ai-use-case-workshop',version:'0.8.0'}, {instructions: `${PARTICIPANT_LANGUAGE_POLICY} ${COMPLETION_POLICY} ${SERVER_QUESTION_POLICY} ${recordCopyGuide}`});
