...
6. Review the group recommendation using the preceding work. New-experience records require only this recommendation; do not start another pilot questionnaire or offer to build after completion. A justified no-pilot recommendation completes the exercise.
