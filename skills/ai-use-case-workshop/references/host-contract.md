...
Snapshots inherit host colours and typography. The inline views, saved reader and PDF share one component system: neutral for current or person-led work, teal for AI activity and amber for a human check or decision. Each phase has an appropriate visual structure grounded in the group's saved words. Do not invent values for charts, truncate essential answers or hide unresolved decisions. Drafts, confirmations and needs-review states remain distinguishable. During the exercise, recovery details remain behind disclosure. On completed Step 6, the supported view automatically opens the full workbook inline with Download PDF prominently at the top. Do not force another View workbook click. A deliberate Close persists through duplicate results, and stale replies must not reopen or replace newer work.
